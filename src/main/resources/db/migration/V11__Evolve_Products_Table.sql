...
ALTER TABLE products
    ADD COLUMN requires_batch_control BOOLEAN NOT NULL DEFAULT FALSE;

ALTER TABLE products
    ADD COLUMN requires_expiry_control BOOLEAN NOT NULL DEFAULT FALSE;
